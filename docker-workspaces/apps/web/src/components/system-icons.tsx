...
export function BatteryIcon({
  ...
  const fill = Math.max(2, Math.min(18, (level / 100) * 18))
  return (
    <svg
      viewBox="0 0 28 16"
      fill="none"
    ...
    >
      <rect
        ...
        strokeWidth="1.4"
      />
      <rect x="24" y="6" width="2.5" height="4" rx="0.6" fill="currentColor" />
      <rect
        x="3"
        y="4"
        width={fill}
...
export function CloseDot({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function BluetoothIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function VolumeIcon({
  ...
  return (
    ...
    >
      ...
      {level > 33 && <path d="M16 9a4 4 0 0 1 0 6" />}
      {level > 66 && <path d="M19 6a8 8 0 0 1 0 12" />}
      {level === 0 && <path d="m17 9 5 6m0-6-5 6" />}
    </svg>
  )
}
...
export function PlaneIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="m3 12 18-7-7 18-2-8-9-3Z" />
    </svg>
  )
}
